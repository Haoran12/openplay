export const dict = {
  ...
  "command.subagent.models": "Subagent models",
  "command.subagent.models.description": "Select models used by roleplay subagents (director, character, gm, narrate)",
  ...
  "dialog.subagentModels.description": "Pick which model each roleplay subagent uses. Leave empty to inherit the parent session model.",
  "dialog.subagentModels.placeholder": "Inherit parent model",
  "subagent.slot.director": "Director",
  "subagent.slot.character": "Character",
  "subagent.slot.gm": "GM",
  "subagent.slot.narrate": "Narrate",
  "subagent.addProvider": "Add provider",
  "subagent.clear": "Clear override",
  "subagent.inherit": "Inherit",
  ...
  "settings.trace.row.defaultReadableSections.description": "Show readable trace sections expanded by default",
  "settings.trace.row.includeSubagentsByDefault.title": "Include subagents by default",
  "settings.trace.row.includeSubagentsByDefault.description":
  ...
  "trace.filter.all": "All Types",
  "trace.filter.main": "Main",
  ...
  "trace.includeSubagents.off": "Subagents off",
  "trace.empty": "No trace entries found for this session yet.",
  "trace.view.readable": "Readable",
  "trace.view.raw": "Raw",
  "trace.copy": "Copy",
  ...
  "roleplay.panel.editRuntime": "Edit runtime.yaml",
  "roleplay.panel.editProfile": "Edit profile",
  "roleplay.panel.openCharacterDirectory": "Open character directory",
  "roleplay.panel.latestEmbodiment": "Latest embodiment",
  "roleplay.panel.noEmbodiment": "No embodiment record yet",
  "roleplay.panel.sceneHistory": "Scene history",
  "roleplay.panel.input": "Input",
  "roleplay.panel.output": "Output",
  "roleplay.panel.speech": "Speech",
  "roleplay.panel.outwardAction": "Outward action",
  "roleplay.panel.actionIntent": "Action intent",
  "roleplay.panel.innerThought": "Inner thought",
  "roleplay.panel.presentCharacters": "Present",
  "roleplay.audit.open": "View model trace",
  "roleplay.audit.title": "Model trace",
  "roleplay.audit.description": "Review what was sent to the model and what came back during this roleplay session.",
  "roleplay.audit.entries": "Entries",
  "roleplay.audit.loading": "Loading full session history...",
  "roleplay.audit.loadOlder": "Load older",
  ...
  "roleplay.audit.time": "Time",
  "roleplay.audit.scope": "Scope",
  "roleplay.audit.session": "Session",
  "roleplay.audit.actor": "Actor",
  "roleplay.audit.requestContent": "Sent to model",
  "roleplay.audit.responseContent": "Received from model",
  "roleplay.reader.title": "Narrative Reader",
  "roleplay.reader.narrativeOnly": "Narrative Only",
  "roleplay.reader.all": "All",
  "roleplay.reader.empty": "No narrative has been produced yet.",
  "roleplay.reader.jumpToTurn": "Jump to turn",
  "roleplay.reader.chapter": "Chapter {{number}}",
  "roleplay.reader.chapterCount": "{{count}} chapters",
}
