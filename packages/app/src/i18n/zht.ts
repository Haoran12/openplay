...
export const dict = {
  ...
  "settings.trace.help": "這裡的設定只控制 UI 顯示，不會替你開啟伺服器採集。要啟用工作階段 Trace，請用 OPENCODE_MODEL_TRACE=1 重新啟動服務。",
  ...
  "trace.unavailable": "伺服器尚未啟用 Trace 採集。請用 OPENCODE_MODEL_TRACE=1 重新啟動服務後再使用工作階段 Trace。",
  "trace.header.label": "Trace",
  "trace.header.enable": "為目前工作階段開啟 Trace",
  "trace.header.disable": "為目前工作階段關閉 Trace",
  "trace.header.unavailable": "目前伺服器未開啟全域模型 Trace 開關，因此無法採集。請用 OPENCODE_MODEL_TRACE=1 重新啟動服務。",
