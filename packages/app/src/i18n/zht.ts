...
export const dict = {
  ...
  "settings.trace.row.showSessionToggle.title": "顯示工作階段 Trace 開關",
  "settings.trace.row.showSessionToggle.description": "在工作階段頁首顯示目前工作階段的 Trace 開關",
  "settings.trace.row.serviceEnabled.title": "啟用 OpenPlay Trace 服務",
  "settings.trace.row.serviceEnabled.description": "允許此 OpenPlay 服務端進行 Trace 採集，開啟後各工作階段級 Trace 開關才能真正記錄事件",
  "settings.trace.row.defaultView.title": "預設 Trace 檢視",
  "settings.trace.row.defaultView.description": "選擇 Trace 閱讀器預設以可讀檢視或原始檢視開啟",
  "settings.trace.row.defaultReadableSections.title": "預設展開可讀區塊",
  "settings.trace.row.defaultReadableSections.description": "在可讀檢視中預設展開各個 Trace 區塊",
  "settings.trace.row.includeSubagentsByDefault.title": "預設包含子代理",
  "settings.trace.row.includeSubagentsByDefault.description": "開啟 Trace 閱讀器時預設包含角色子工作階段與其他子代理鏈路",
  "settings.trace.option.readable": "可讀",
  "settings.trace.option.raw": "原始",
  "settings.trace.help": "先用下面的 OpenPlay Trace 服務開關允許目前服務端採集；其餘設定只控制 UI 顯示方式。",
  "trace.dialog.title": "Trace 閱讀器",
  "trace.dialog.description": "查看此工作階段最近 {{days}} 天的模型 Trace 記錄。",
  "trace.dialog.entries": "條目",
  "trace.filter.all": "全部類型",
  "trace.filter.main": "主工作階段",
  ...
  "trace.includeSubagents.off": "僅目前工作階段",
  "trace.empty": "此工作階段目前沒有可顯示的 Trace 記錄。",
  "trace.view.readable": "可讀",
  "trace.view.raw": "原始",
  "trace.copy": "複製",
  "trace.copySuccess": "已複製 Trace 條目",
  "trace.unavailable": "目前 OpenPlay 服務端尚未啟用 Trace 採集。請先在設定中開啟 OpenPlay Trace 服務。",
  "trace.header.label": "Trace",
  "trace.header.enable": "為目前工作階段開啟 Trace",
  "trace.header.disable": "為目前工作階段關閉 Trace",
  "trace.header.unavailable": "目前 OpenPlay Trace 服務未啟用，因此無法採集。",
  "trace.header.enableGlobal": "啟用 OpenPlay Trace 服務並開始採集目前工作階段",
  "trace.header.globalStillOff": "OpenPlay Trace 服務仍未開啟",
  "trace.header.globalStillOffDescription": "更新後服務端仍未回傳可用狀態，請檢查服務設定後重試。",
  "trace.header.open": "打開 Trace 閱讀器。伺服器保留期：{{days}} 天。",
  "trace.header.openButton": "閱讀器",
  "trace.status.on": "Trace 開啟",
  "trace.status.off": "Trace 關閉",
  ...
  "common.unknown": "未知",
  "roleplay.audit.open": "查看模型軌跡",
  "roleplay.audit.title": "模型軌跡",
  "roleplay.audit.description": "查看本次 roleplay 工作階段中實際送給模型的內容，以及模型回傳的結果。",
  "roleplay.audit.entries": "軌跡條目",
  "roleplay.audit.loading": "正在載入完整工作階段歷史...",
  "roleplay.audit.loadOlder": "載入更早內容",
  ...
  "roleplay.audit.time": "時間",
  "roleplay.audit.scope": "歸屬",
  "roleplay.audit.session": "工作階段",
  "roleplay.audit.actor": "執行者",
  "roleplay.audit.requestContent": "送給模型",
  "roleplay.audit.responseContent": "模型回傳",
