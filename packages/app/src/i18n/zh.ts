...
export const dict = {
  ...
  "settings.trace.help": "这里的设置只控制 UI 展示，不会替你开启服务端采集。要启用会话 Trace，请用 OPENCODE_MODEL_TRACE=1 重启服务。",
  ...
  "trace.unavailable": "服务端未启用 Trace 采集。请使用 OPENCODE_MODEL_TRACE=1 重启服务后再使用会话级 Trace。",
  "trace.header.label": "Trace",
  "trace.header.enable": "为当前会话开启 Trace",
  "trace.header.disable": "为当前会话关闭 Trace",
  "trace.header.unavailable": "当前服务端未开启全局模型 Trace 开关，因此无法采集。请使用 OPENCODE_MODEL_TRACE=1 重启服务。",
