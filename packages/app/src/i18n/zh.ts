...
export const dict = {
  ...
  "settings.general.section.trace": "Trace",
  "settings.trace.row.showSessionToggle.title": "显示会话 Trace 开关",
  "settings.trace.row.showSessionToggle.description": "在会话页顶部显示当前会话的 Trace 开关",
  "settings.trace.row.serviceEnabled.title": "启用 OpenPlay Trace 服务",
  "settings.trace.row.serviceEnabled.description": "允许此 OpenPlay 服务端进行 Trace 采集，开启后各会话级 Trace 开关才能真正记录事件",
  "settings.trace.row.defaultView.title": "默认 Trace 视图",
  "settings.trace.row.defaultView.description": "选择 Trace 阅读器默认打开为可读视图还是原始视图",
  "settings.trace.row.defaultReadableSections.title": "默认展开可读区块",
  "settings.trace.row.defaultReadableSections.description": "在可读视图中默认展开各个 Trace 区块",
  "settings.trace.row.includeSubagentsByDefault.title": "默认包含子代理",
  "settings.trace.row.includeSubagentsByDefault.description": "打开 Trace 阅读器时默认包含角色子会话和其他子代理链路",
  "settings.trace.option.readable": "可读",
  "settings.trace.option.raw": "原始",
  "settings.trace.help": "先用下面的 OpenPlay Trace 服务开关允许当前服务端采集；其余设置只控制 UI 展示方式。",
  "trace.dialog.title": "Trace 阅读器",
  "trace.dialog.description": "查看该会话最近 {{days}} 天的模型 Trace 记录。",
  "trace.dialog.entries": "条目",
  "trace.filter.all": "全部类型",
  "trace.filter.main": "主会话",
  "trace.filter.subagent": "子代理",
  "trace.filter.tool": "工具",
  "trace.filter.model": "模型",
  "trace.timeFilter.all": "全部时间",
  "trace.timeFilter.1h": "1小时内",
  "trace.timeFilter.today": "今日内",
  "trace.includeSubagents.on": "包含子代理",
  "trace.includeSubagents.off": "仅当前会话",
  "trace.empty": "该会话还没有可显示的 Trace 记录。",
  "trace.view.readable": "可读",
  "trace.view.raw": "原始",
  "trace.copy": "复制",
  "trace.copySuccess": "Trace 条目已复制",
  "trace.unavailable": "当前 OpenPlay 服务端未启用 Trace 采集。请先在设置中开启 OpenPlay Trace 服务。",
  "trace.header.label": "Trace",
  "trace.header.enable": "为当前会话开启 Trace",
  "trace.header.disable": "为当前会话关闭 Trace",
  "trace.header.unavailable": "当前 OpenPlay Trace 服务未启用，因此无法采集。",
  "trace.header.enableGlobal": "启用 OpenPlay Trace 服务并开始采集当前会话",
  "trace.header.globalStillOff": "OpenPlay Trace 服务仍未开启",
  "trace.header.globalStillOffDescription": "更新后服务端仍未返回可用状态，请检查服务配置后重试。",
  "trace.header.open": "打开 Trace 阅读器。服务端保留期：{{days}} 天。",
  "trace.header.openButton": "阅读器",
  "trace.status.on": "Trace 开启",
  "trace.status.off": "Trace 关闭",
  ...
  "common.unknown": "未知",
  "roleplay.panel.scene": "当前场景",
  "roleplay.panel.characters": "在场人物",
  "roleplay.panel.noScene": "尚未设置场景",
  "roleplay.panel.noCharacters": "当前无在场人物",
  "roleplay.panel.editRuntime": "编辑 runtime.yaml",
  "roleplay.panel.editProfile": "编辑角色档案",
  "roleplay.panel.openCharacterDirectory": "打开角色目录",
  "roleplay.panel.latestEmbodiment": "最近一次代入",
  "roleplay.panel.noEmbodiment": "暂无代入记录",
  "roleplay.panel.sceneHistory": "场景变更时间线",
  "roleplay.panel.input": "输入",
  "roleplay.panel.output": "输出",
  "roleplay.panel.speech": "发言",
  "roleplay.panel.outwardAction": "外显动作",
  "roleplay.panel.actionIntent": "行动意图",
  "roleplay.panel.innerThought": "内心独白",
  "roleplay.panel.presentCharacters": "在场人物",
  "roleplay.audit.open": "查看模型轨迹",
  "roleplay.audit.title": "模型轨迹",
  "roleplay.audit.description": "查看本次 roleplay 会话中真实发给模型的内容，以及模型返回的结果。",
  "roleplay.audit.entries": "轨迹条目",
  "roleplay.audit.loading": "正在加载完整会话历史...",
  "roleplay.audit.loadOlder": "加载更早内容",
  ...
  "roleplay.audit.time": "时间",
  "roleplay.audit.scope": "归属",
  "roleplay.audit.session": "会话",
  "roleplay.audit.actor": "执行者",
  "roleplay.audit.requestContent": "发送给模型",
  "roleplay.audit.responseContent": "模型返回",
  "roleplay.reader.title": "叙事阅读",
  "roleplay.reader.narrativeOnly": "仅看叙事",
  "roleplay.reader.all": "全部",
  "roleplay.reader.empty": "当前会话还没有叙事正文。",
  "roleplay.reader.jumpToTurn": "跳到该回合",
  "roleplay.reader.chapter": "章节 {{number}}",
  "roleplay.reader.chapterCount": "{{count}} 章",
