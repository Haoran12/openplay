...
beforeAll(async () => {
  ...
  mock.module("@openplay-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@openplay-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@openplay-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@openplay-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
