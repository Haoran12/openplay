import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@openplay-ai/sdk/v2"
import { SessionTurn } from "@openplay-ai/ui/session-turn"
import { SessionReview } from "@openplay-ai/ui/session-review"
import { DataProvider } from "@openplay-ai/ui/context"
import { FileComponentProvider } from "@openplay-ai/ui/context/file"
import { WorkerPoolProvider } from "@openplay-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@openplay-ai/ui/logo"
import { IconButton } from "@openplay-ai/ui/icon-button"
import { ProviderIcon } from "@openplay-ai/ui/provider-icon"
import { iife } from "@openplay-ai/core/util/iife"
import { Binary } from "@openplay-ai/core/util/binary"
import { NamedError } from "@openplay-ai/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@openplay-ai/ui/tabs"
import { MessageNav } from "@openplay-ai/ui/message-nav"
import { FileSSR } from "@openplay-ai/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@openplay-ai/ui/pierre/worker").then((m) => ({
