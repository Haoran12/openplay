  ...
  const execute = (params: Schema.Schema.Type<typeof Parameters>, ctx: Tool.Context<KnowledgeReflectMetadata>) =>
    Effect.gen(function* () {
      ...
      const systemPrompt = [
        ...
        "Good fits include stable understanding about society, nature, your own body or senses, and specific other people.",
        "Prefer editing an existing resource when the topic already exists; create a new people/<name>.md file when a specific person's file is warranted.",
