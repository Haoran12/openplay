...
async function ensureCharacterReadme(targetDir: string): Promise<void> {
  ...
  await Filesystem.write(
    ...
    [
      ...
      "- `knowledge/`: character-owned long-term knowledge.",
      "- `knowledge/world_base.yaml`: overall worldview and natural laws — broad, general rules.",
      "- `knowledge/social_and_world.md`: broad social patterns, political culture, worldly judgment.",
      "- `knowledge/nature_and_body.md`: nature, body, sensory, and environmental experience.",
      "- Create additional `.md` files for specific persons, regions, or factions (e.g., `li_ming.md`).",
      "",
    ].join("\n"),
  )
}
