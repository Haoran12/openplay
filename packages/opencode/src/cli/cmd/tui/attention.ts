...
} from "@openplay-ai/plugin/tui"
import stripAnsi from "strip-ansi"
import type { TuiConfig } from "./config/tui"
import { isAttentionSoundName } from "./config/tui-schema"
import * as TuiAudio from "@tui/util/audio"
import defaultSoundPath from "@openplay-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@openplay-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@openplay-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@openplay-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@openplay-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@openplay-ai/ui/audio/yup-01.mp3" with { type: "file" }
